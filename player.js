...
function ControlBar() {
  ...
  const volume_on_img = 'url(https://puffer.stanford.edu/static/puffer/dist/images/volume-on.svg)';
  const volume_off_img = 'url(https://puffer.stanford.edu/static/puffer/dist/images/volume-off.svg)';
  ...
  const enter_fullscreen_img = 'url(https://puffer.stanford.edu/static/puffer/dist/images/enter-fullscreen.svg)';
  const exit_fullscreen_img = 'url(https://puffer.stanford.edu/static/puffer/dist/images/exit-fullscreen.svg)';
